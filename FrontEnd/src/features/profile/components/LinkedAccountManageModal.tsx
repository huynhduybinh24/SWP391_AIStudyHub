          ...
          >
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-slate-800/60 mt-6 gap-3">
              {account.id !== 'google' ? (
                ...
                <span className="text-[11px] font-semibold text-slate-400 dark:text-slate-500 italic bg-slate-100 dark:bg-slate-800/60 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700/50">
                  {language === 'vi' ? '● Đã kết nối Google Drive cố định' : '● Google Drive permanently connected'}
                </span>
              )}
