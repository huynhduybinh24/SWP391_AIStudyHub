...
import { Sparkles, Folder, FileCheck, AlertCircle, Video as VideoIcon, Music, X, Loader2, CheckCircle2 } from 'lucide-react';
      ...
      pollingIntervalRef.current = setInterval(async () => {
        try {
          ...
          if (doc.moderationStatus === 'APPROVED') {
            ...
            if (setDocuments) {
              setDocuments((prev: any) => [mapBackendDocToItem(doc), ...prev]);
            }
