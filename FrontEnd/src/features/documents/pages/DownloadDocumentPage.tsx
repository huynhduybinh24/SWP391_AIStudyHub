    ...
    <div className="space-y-7 relative">
      ...
      <div className="flex select-none">
        <button
          ...
          className="group flex items-center gap-2 text-xs font-bold text-slate-500 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-7 items-start">
        ...
        <div className="lg:col-span-5">
          <div className="bg-white dark:bg-slate-900 border border-slate-200/85 dark:border-slate-800 rounded-3xl p-6 shadow-md space-y-6 flex flex-col text-left">
            
            {/* Themed Document Brain Cover Image */}
            <div className="border border-slate-200/85 dark:border-slate-800 rounded-2xl overflow-hidden shadow-inner bg-slate-950 p-2.5 relative group min-h-[190px] flex items-center justify-center">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between gap-3">
                <h2 className="text-xl font-extrabold text-slate-900 dark:text-slate-100 leading-snug tracking-tight">
                  {docTitle}
                </h2>
              </div>
              ...
              {/* Shared badge pill */}
              <div className="flex">
                <span className="flex items-center gap-1.5 text-[10px] tracking-wide font-black uppercase bg-blue-50 dark:bg-blue-955/30 border border-blue-100 dark:border-blue-900/30 text-blue-600 dark:text-blue-400 px-3.5 py-1.5 rounded-full shadow-sm select-none">
            ...
            <div className="grid grid-cols-3 gap-3 border-t border-slate-100 dark:border-slate-800 pt-5 text-left">
              <div className="space-y-1">
                <div className="flex items-center gap-1 text-slate-400 dark:text-slate-500">
                  <Download className="h-3.5 w-3.5" />
                  <span className="text-[9px] font-black uppercase tracking-wider">File Size</span>
                </div>
                <p className="text-sm font-bold text-slate-700 dark:text-slate-300 select-all">
                  {docSize}
                </p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold text-slate-700 dark:text-slate-300 select-none">
                  {docPages} pages
                </p>
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold text-slate-700 dark:text-slate-300 select-none truncate">
                  {docUploaded}
                </p>
              </div>
            </div>
        ...
        <div className="lg:col-span-7">
          <div className="bg-white dark:bg-slate-900 border border-slate-200/85 dark:border-slate-800 rounded-3xl p-6 shadow-md space-y-6 flex flex-col text-left relative overflow-visible">
            ...
            {/* Alert Access Block */}
            <div className="bg-blue-50/70 dark:bg-blue-955/20 border border-blue-100/60 dark:border-blue-900/30 p-4 rounded-2xl flex items-center gap-3.5 animate-fade-in select-none">
              <div className="bg-blue-500/10 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 p-2 rounded-xl flex items-center justify-center shrink-0 border border-blue-100/50 dark:border-blue-900/20 shadow-inner">
                <ShieldCheck className="h-5 w-5 text-blue-655 dark:text-blue-400" />
              </div>
              <span className="text-xs font-bold text-blue-800 dark:text-blue-300 leading-normal">
            ...
            <div className="space-y-4">
              ...
              <div className="border border-slate-200/70 dark:border-slate-800 hover:border-blue-200 dark:hover:border-blue-900/30 hover:bg-slate-50/30 dark:hover:bg-slate-850/30 transition-all p-4.5 rounded-2xl flex items-center justify-between gap-4">
                <div className="space-y-1 text-left min-w-0">
                  <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200 leading-snug">
                    Download Original File
                  </h4>
                  <p className="text-xs text-slate-400 dark:text-slate-500 font-semibold leading-relaxed truncate">
              ...
              <div className="border border-slate-200/70 dark:border-slate-800 hover:border-blue-200 dark:hover:border-blue-900/30 hover:bg-slate-50/30 dark:hover:bg-slate-850/30 transition-all p-4.5 rounded-2xl flex items-center justify-between gap-4">
                <div className="space-y-1 text-left min-w-0">
                  ...
                  <p className="text-xs text-slate-400 dark:text-slate-500 font-semibold leading-relaxed truncate mt-1">
              ...
              <div className="border border-slate-200/70 dark:border-slate-800 hover:border-blue-200 dark:hover:border-blue-900/30 hover:bg-slate-50/30 dark:hover:bg-slate-850/30 transition-all p-4.5 rounded-2xl flex flex-col gap-4">
                ...
                <div className="relative inline-block text-left" ref={formatDropdownRef}>
                  ...
                  {isFormatDropdownOpen && (
                    <div className="absolute left-0 mt-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-lg rounded-xl z-20 py-1 w-32 animate-fade-in text-left">
                      {(['ZIP', 'PDF'] as const).map((fmt) => (
                        <button
                          ...
                          className={cn(
                            "w-full text-left px-3.5 py-2 text-xs font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 flex items-center justify-between transition-colors",
                            downloadFormat === fmt ? "text-blue-600 dark:text-blue-400 bg-blue-50/40 dark:bg-blue-955/30" : "text-slate-700 dark:text-slate-350"
                          )}
                        >
                          <span>{fmt}</span>
                          {downloadFormat === fmt && <Check className="h-3.5 w-3.5 text-blue-600 dark:text-blue-400" />}
                        </button>
                      ))}
                    </div>
                  )}
      ...
      <AnimatePresence>
        {activeDownloadType && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 z-50 w-full max-w-sm bg-white dark:bg-slate-900 border border-slate-250/90 dark:border-slate-800 rounded-3xl p-5 shadow-2xl flex flex-col gap-3 font-sans select-none text-left"
          >
            {/* Header description info */}
            <div className="flex justify-between items-start">
              <div className="min-w-0 flex-1">
                <h4 className="text-xs font-extrabold text-slate-900 dark:text-slate-100 truncate leading-snug" title={getFileName(activeDownloadType)}>
              ...
              <span className="text-xs font-black text-slate-700 dark:text-slate-350 shrink-0 ml-3">
                {downloadProgress}%
              </span>
            </div>
            ...
            <div className="flex justify-between items-center text-[10px] font-semibold text-slate-400 dark:text-slate-500">
              ...
              <button
                ...
                className="text-rose-600 hover:text-rose-700 font-extrabold cursor-pointer transition-colors px-2 py-1 rounded-lg hover:bg-rose-50 dark:hover:bg-rose-955/30"
              >
                Cancel
              </button>
            </div>
