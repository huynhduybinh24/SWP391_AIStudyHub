      ...
      <div className="space-y-1.5 w-full">
        ...
        <div className="relative">
          ...
          <input
            ref={ref}
            className={cn(
              'w-full h-11 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200/80 dark:border-slate-850 px-3.5 text-sm font-semibold text-slate-900 dark:text-white transition-all placeholder-slate-400 dark:placeholder-slate-600 focus:outline-none focus:border-[#3155F6] focus:ring-2 focus:ring-[#3155F6]/10 dark:focus:ring-[#3155F6]/5',
              leftIcon && 'pl-11',
              rightIcon && 'pr-11',
