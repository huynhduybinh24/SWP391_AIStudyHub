...
public class TestAivenConn {
    public static void main(String[] args) {
        String aivenUrl = "jdbc:mysql://mysql-3234de44-lumiedu-project1.d.aivencloud.com:12699/defaultdb?useSSL=true&trustServerCertificate=true&allowPublicKeyRetrieval=true&serverTimezone=Asia/Ho_Chi_Minh";
